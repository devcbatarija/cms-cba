...
const AmericanSpaces = () => {
    ...
    return (
        <>
            <div>
                <img src="https://i.ibb.co/WWXmKD4/download-image-1714055930176.png" alt="" />
                <div className="">
                    <div className="flex flex-wrap ">
                        <div className="w-full lg:w-2/5 flex flex-col md:flex-row lg:flex-col pl-7 pr-7 pt-10 ">
                            <h1 class="mb-4 text-2xl font-extrabold  text-gray-900 dark:text-white md:text-2xl lg:text-2xl">
