...
import { Avatar, Button, Checkbox, Grid } from "@mui/material"; // Importa componentes de Material-UI como botones y avatares.
...
export default function TableUser() {
  ...
  const handleModal = (id) => {
    //Para poder seleccionar un usuario que se va a editar
          ...
          {data &&
            data.map((row, index) => (
              ...
              >
                ...
                <TableCell align="center">
                  {row.estado ? "Habilitado" : "Desabilitado"}
                </TableCell>
                <TableCell align="center">
                  <Button
                    variant="contained"
