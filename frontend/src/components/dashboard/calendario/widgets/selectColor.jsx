    ...
    <Listbox value={selected} onChange={setSelected}>
      {({ open }) => (
        <>
          ...
          <div className="relative" style={{backgroundColor:'red', flex:1}}>
            <Listbox.Button className="h-full relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6">
