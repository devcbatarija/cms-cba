...
/* ===== Estilos del RichEditor (idéntico al de Nueva publicación) ===== */
...
export default function ModalUpdatePublication({ id, open, handleClose }) {
  ...
  // Handler específico para el HTML que devuelve el RichEditor
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setSpinner(true);
      await axios.put(`publication/update/${id}`, form);
      setTimeout(() => {
      ...
      <div style={styles.modal}>
        ...
        <div style={styles.modalHeader}>
          <div style={styles.modalTitleWrap}>
            ...
            <h2 style={styles.modalTitle}>Editar publicación</h2>
          </div>
          ...
          {skeleton ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={styles.grid2}>
                ...
                {/* Descripción — mismo RichEditor usado en Nueva publicación */}
                <div style={{ ...styles.fieldGroup, ...styles.fullField }}>
