...
const { addEvento, getAllEvento, updateEvento, getEventById, getActiveEvents, deleteEventoById, deleteSelectedEvents } = require("../handlers/eventoHandler");
...
router.post('/deleteSelectedEvents', isAdmin, deleteSelectedEvents)
